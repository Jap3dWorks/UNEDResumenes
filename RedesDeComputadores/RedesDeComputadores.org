...
- *MTU*, longitud máxima de la carga útil de la trama.
...
- *Campos*
      ...
      - *HLEN* (4 Bits)
      - *Longitud de la cabecera* (4 Bits), número de palabras de 4 bytes.
...
- Pasos A envía a B
      ...
      2. El cliente *MTA (agente de transferencia de mensajes)* de A (incluido en su UA) manda el mensaje al servidor MTA de A
      3. El servidor MTA de A pone el mensaje en una cola
      4. El servidor De A tiene un cliente MTA que consulta la cola
             - Cuando este cliente ve el mensaje lo manda al Servidor de B al servicio de MTA
