...
- Asegura la *consistencia de procesador*, Las instrucciones concluyen el procesamiento en el mismo
  orden secuencial que el programa.
...
** VLIW
- Puede emitir y terminar varias operaciones en paralelo (similar a superescalar).
...
- Repertorio de instrucciones VLIW
      ...
      - Tamaño de instrucción más habitual son 256 bits.
            - | Salto |Carga/almac | Carga/almac | Entera | Entera | float | float | Util |
...
- Tareas que requiere el compilador
      ...
      - *Grafo del flujo de datos*.
            ...
            - *Planificación global*, Se combinan instrucciones de varios bloques.
                  - *Planificación de trazas*, #TODO
            - Muestra las instrucciones sin dependencia entre ellas.

** Instrucciones con Predicado
- El predicado determina si se ejecuta o no la instrucción.
