...
fun Dijkstra(G=<N,A>:grafo): VectorNat, VectorNat
    ...
    mientras C contenga más de 1 nodo hacer
        v <- nodo in C que minimiza especial[]  // Un nodo con el menor peso de camino
        C <- C \ {v}
...
- Suponemos que las tareas están ordenadas tal que.
  $b_i \leq b_2 \leq \dots \leq \b_n$
...
* Tareas
** TODO [[id:ad3eb2c8-5ccf-44d3-bc53-c006098e81ae][Practicar Planificador de Tareas]]
** TODO Practicar Prim y Kruscal
